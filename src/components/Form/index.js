...
export default function Form() {
    ...
    function imcCalculator() {
        let heightFormat = height.replace(",", ".");                     // android aparece . e ios aparece ,
        ...
        <View style={styles.formContext}>
            {imc == null ?
                <Pressable onPress={Keyboard.dismiss} style={styles.form}>
                    ...
                    <Text style={styles.errorMessage}>{errorMessage}</Text>
                    <TextInput style={styles.input} onChangeText={setWeight} value={weight} placeholder='Ex: 85.356' keyboardType='numeric' />
                    <TouchableOpacity
